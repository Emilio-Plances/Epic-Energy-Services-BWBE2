...
public class UserController {
    ...
    @PostMapping("")
    public ResponseEntity<DefaultResponse> createUser(@RequestBody @Validated UserRequest userRequest, BindingResult bindingResult) throws NotFoundException, BadRequestExceptionHandler {
